        ...
        <div class="col-lg-12 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('alternatif.update', $alternatif->id) }}" autocomplete="off" id="myForm">
                        @csrf
                        @method('PUT')
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="nama_alternatif" class="form-control" name="nama_alternatif" value="{{$alternatif->nama_alternatif}}">
                                    </div>
                                </div>
                            </div>
